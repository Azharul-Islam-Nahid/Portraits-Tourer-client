        ...
        <div className='container m-auto mt-0'>
            <div className="hero min-h-screen">
                <div className="hero-content flex-col lg:flex-row">
                    <img className='w-6/12' src='https://i.ibb.co/V384sCG/tour-guide-provide-assistance-banner-organize-visit-museum-attraction-site-interest-cultural-histori.jpg' alt='' />
                    <div>
